  <?php 
      ...
      if(isset($_POST['btnSave'])){
          ...
          $myquery = "UPDATE  tblappointments SET dates = '$txtdate', timee = '$txttime', services = '$txtservice' WHERE appointmentId = '$firstname'"; 
          $myresult = mysqli_query($connection,$myquery); 
          
          

          if($myresult){
            $registerMessage = "Bookings Details Updated Successfully";
        } else {
            $registerMessage = "Error updating record: " . mysqli_error($connection);
        }
          ...
          if(isset($_POST['btnDelete'])){
            ...
            $myquery = "DELETE FROM tblappointments WHERE appointmentId = '$firstname'"; 
            $myresult = mysqli_query($connection,$myquery); 
          
            $registerMessage = "Deleted successfully";
        }
  ...
  <html lang="en">
    ...
    <nav class="p-5 flex items-center justify-between text-black ">
      ...
      <section class="side-main flex-1 bg-gray-100 p-10">
          ...
          <form method="POST" class="bg-white p-5 h-full w-full max-w-2xl rounded-md" id="booking-form" onsubmit="confirmUpdate(event);">
                  ...
                  <button type="submit" class="bg-black text-white p-5 w-28 float-end" name="btnSave" id="savedata">Save</button>
