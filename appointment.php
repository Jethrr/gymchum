              ...
              <?php
                    ...
                    if (mysqli_num_rows($query2) > 0) {
                      while ($row = mysqli_fetch_assoc($query2)) {
                          ...
                          // echo "<td class='p-3 text-sm text-gray-700 whitespace-nowrap'>" . '<button class="bg-black text-white pl-5 pr-5 pt-1 pb-1 rounded-full font-semibold" onclick="openBookingsTab(\'' . $row["userId"] . '\')">Book</button>' . "</td>";
                          echo "</tr>";
                      }
                  } else {
